...
function CartList() {
    ...
    <div key={item.id}>
        <div className={`d-flex align-items-start flex-wrap p-3 rounded-4 shadow-sm ${styles.cartCard} mb-3`}>
            ...
            {/* actions */}
            <div className={`flex-fill d-flex flex-column align-items-center gap-2 ${styles.cartCard} ${styles.actionsCol}`}>
                ...
                {/* rimuovi centrato */}
                <button
                    className="btn btn-outline-secondary rounded-3 px-3 py-1 w-auto"
