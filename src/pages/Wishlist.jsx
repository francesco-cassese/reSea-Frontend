        ...
        <>
            {wishlist.length === 0 ? (
                <div className="d-flex flex-column align-items-center justify-content-center text-center py-5">
                    <i className={`bi bi-heart text-warning ${styles.emptyIcon}`}></i>
                                        ...
                                        <div className={styles.wishlistButtons}>
                                            ...
                                            {!inCart ? (
                                                ...
                                                <QuantityStepper
                                                    ...
                                                    wrapperClassName={`${styles.btnAddToCartGrid} d-flex rounded-pill justify-content-between align-items-center px-3 ${styles.gradientBtn}`}
                                                    buttonClassName="btn btn-sm text-white p-0"
                                                    minusButtonClassName="btn btn-sm text-white p-0 rounded-pill"
